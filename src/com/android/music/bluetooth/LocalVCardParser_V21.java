...
public class LocalVCardParser_V21 {
    ...
    protected boolean parseItem() throws IOException, VCardException {
        ...
        {
            Log.e(TAG, "Unknown property name: \"" + propertyName + "\"");
        }
        return false;
    }
    ...
    protected void handleParams(String params) throws VCardException {
        ...
        if (strArray.length == 2) {
            ...
            if (paramName.equals("TYPE")) {
                ...
                {
                    Log.e(TAG, "Unknown type: \"" + paramName + "\"");
                }
            }
        } else {
    ...
    protected void handleType(String ptypeval) throws VCardException {
        if (sKnownTypeSet.contains(ptypeval.toUpperCase()) ||
            ...
            if(ERROR_THROW_EXCEPTION)
            {
               throw new VCardException("handleType - Unknown type: \"" +
                       ptypeval + "\"");
            }
            else
            {
                Log.e(TAG, "handleType - Unknown type: \"" + ptypeval + "\"");
            }
        }
    }
    ...
    protected void handleValue(String pvalueval) throws VCardException {
        if (sKnownValueSet.contains(pvalueval.toUpperCase()) ||
            ...
            if(ERROR_THROW_EXCEPTION)
            {
               throw new VCardException("handleType - Unknown value: \"" +
                        pvalueval + "\"");
            }
            else
            {
                Log.e(TAG, "handleType - Unknown value: \"" + pvalueval + "\"");
            }
        }
    }
    ...
    protected void handleEncoding(String pencodingval) throws VCardException {
        if (isValidEncoding(pencodingval) ||
            ...
            {
                Log.e(TAG, "Unknown encoding: \"" + pencodingval + "\"");
            }
        }
    }
    ...
    protected void handleLanguage(String langval) throws VCardException {
        ...
        if (strArray.length != 2) {
            ...
            {
                Log.e(TAG, "Invalid Language: \"" + langval + "\"");
                return;
            }
        }
    ...
    protected void handlePropertyValue(
        ...
        if (mEncoding == null || mEncoding.equalsIgnoreCase("7BIT")
            ...
            {
                Log.e(TAG, "Invalid encoding: \"" + mEncoding + "\"");
                return;
            }
        }
    }
        ...
        if (firstString.trim().endsWith("=")) {
            ...
            while (true) {
                ...
                if (line == null) {
                    ...
                    {
                        Log.e(TAG, "File ended during parsing quoted-printable String");
    ...
    protected String getBase64(String firstString) throws IOException, VCardException {
        ...
        while (true) {
            ...
            if (line == null) {
                ...
                {
                    Log.e(TAG, "File ended during parsing BASE64 binary");
                    return builder.toString();
                }
            }
            if (line.length() == 0) {
    ...
    protected void handleAgent(String propertyValue) throws IOException, VCardException {
        ...
        if (!(strArray.length == 2 ||
                strArray[0].trim().equalsIgnoreCase("BEGIN") &&
                strArray[1].trim().equalsIgnoreCase("VCARD"))) {
            /* If a VCARD is not embedded, return */
            if(ERROR_THROW_EXCEPTION)
            {
            ...
            {
                Log.e(TAG, "BEGIN:VCARD != \"" + propertyValue + "\"");
            }
            return ;
        }
        parseItems();
